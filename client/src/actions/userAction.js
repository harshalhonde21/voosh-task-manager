...
export const registerUser = (userData) => async (dispatch) => {
  ...
  try {
    ...
    const response = await axios.post(`${API_URL}/api/v1/users/register`, userData, config);
...
export const loginUser = (userData) => async (dispatch) => {
  ...
  try {
    ...
    const response = await axios.post(`${API_URL}/api/v1/users/login`, userData, config);
...
export const isLogin = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`${API_URL}/api/v1/users/isLogin`, config);
...
export const googleAuth = () => async (dispatch) => {
  try {
    ...
    const response = await axios.post(`${API_URL}/api/v1/users/firebase-auth`, { token }, config);
